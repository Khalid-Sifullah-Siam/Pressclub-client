...
export const metadata: Metadata = {
  title: "Privacy Policy | Khalid Saifullah Siam",
  description:
    "Read the privacy policy of siyam.dev to understand how user data is collected, used, and protected.",
  keywords: [
    "Privacy Policy",
    "siyam.dev",
    "data protection",
  ...
  alternates: {
    canonical: "https://siyam.dev/privacy-policy",
  },
  openGraph: {
    title: "Privacy Policy | Khalid Saifullah Siam",
    description:
      "Learn how siyam.dev handles user privacy and data protection.",
    url: "https://siyam.dev/privacy-policy",
    siteName: "Khalid Saifullah Siam",
    type: "website",
  },
};
