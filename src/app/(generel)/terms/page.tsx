...
export const metadata: Metadata = {
  title: "Terms & Conditions | Khalid-Sifullah-Siam",
  description:
    "Read the terms and conditions for using siyam.dev.",
  keywords: [
  ...
  alternates: {
    canonical: "https://siyam.dev/terms-and-conditions",
  },
  openGraph: {
    title: "Terms & Conditions | Khalid-Sifullah-Siam",
    description:
      "Review the terms and conditions for using siyam.dev.",
    url: "https://siyam.dev/terms-and-conditions",
    siteName: "Khalid-Sifullah-Siam",
    type: "website",
  },
};
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <section className="space-y-4">
          ...
          <p className="text-zinc-300 leading-8">
            ...
            design remains the property of siyam.dev unless
            otherwise stated.
          </p>
        </section>
