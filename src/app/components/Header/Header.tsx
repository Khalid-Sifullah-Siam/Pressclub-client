                ...
                <div>
                  <ul className="flex items-center gap-6">
                    ...
                    <li className="group flex items-center gap-2 font-semibold text-gray-400 hover:text-white transition-all duration-200">
                      <a
                        href="https://www.linkedin.com/in/khalid-sifullah-siam?trk=contact-info"
                        target="_blank"
        ...
        >
          ...
          >
            ...
            <div className="text-center mt-4 px-6">
              <h2 className="text-xl font-bold text-white">Khalid Saifullah Siyam</h2>
              <p className="text-orange-400 text-sm mt-1">MERN STACK DEVELOPER</p>
